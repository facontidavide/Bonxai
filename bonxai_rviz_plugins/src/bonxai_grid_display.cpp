...
namespace bonxai_rviz_plugins
{
        ...
        float &cell)
    {
        ...
        case BONXAI_PROBABILITY_COLOR:
            // TODO: Add min/max parameter for scaling between 0 and 1
        ...
        const bonxai_msgs::msg::Bonxai::ConstSharedPtr msg)
    {
        ...
        auto visitor_func = [&](CellT &cell, const Bonxai::CoordT &coord)
        {
            ...
            // TODO (jjd9): A more rigorous check could help but would also sacrifice
            // efficiency, plus rviz is likely already doing some form of culling 
            // to reduce rendering effort.
    ...
    // TODO (jjd9): Is there a better way to just expose all integral types
    // under this scalar banner?
