...
public:
    MinimalPublisher()
        : Node("bonxai_publisher"), num_points_(0)
    {
        scalar_publisher_ = this->create_publisher<bonxai_msgs::msg::Bonxai>("bonxai/scalar", 1);
        color_publisher_ = this->create_publisher<bonxai_msgs::msg::Bonxai>("bonxai/color", 1);
...
private:
    ...
    rclcpp::Publisher<bonxai_msgs::msg::Bonxai>::SharedPtr scalar_publisher_, color_publisher_;
