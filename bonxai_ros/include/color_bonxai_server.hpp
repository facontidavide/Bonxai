#ifndef BONXAI_SERVER__COLOR_BONXAI_SERVER_HPP_
#define BONXAI_SERVER__COLOR_BONXAI_SERVER_HPP_
...
class ColorBonxaiServer : public rclcpp::Node {
 public:
  using PCLPoint = pcl::PointXYZRGB;
  using PCLPointCloud = pcl::PointCloud<pcl::PointXYZRGB>;
  using BonxaiT = Bonxai::ColorProbabilisticMap;
  using ResetSrv = std_srvs::srv::Empty;

  explicit ColorBonxaiServer(const rclcpp::NodeOptions& node_options);
...
#endif  // BONXAI_SERVER__COLOR_BONXAI_SERVER_HPP_
